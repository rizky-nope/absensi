...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Absensi</b><b> </b>Siswa</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url('temp/dist/img/tutwuri.png'); ?>" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataSiswa'); ?>">XI RPL 1</a></li>
        <li><a href="<?php echo site_url('Welcome/DataSiswa2'); ?>">XI RPL 2</a></li>


        <li class="header">Menu Tambahan</li>
        <li><a href="<?php echo site_url('Welcome/Register'); ?>">Daftar Akun</a></li>
